...
import aravatImage from "@/@assets/avatar.png";

interface Props {}

export const PersonalInformation: FC<Readonly<Props>> = () => {
  return (
    <section className="w-full h-auto flex flex-col md:flex-row justify-start items-stretch">
      <div className="md:max-w-xs w-full p-4 bg-teal-600 md:rounded-l-xl md:rounded-r-none rounded-t-xl flex flex-col justify-center items-center">
        ...
        <DownloadCV
          file="/sample.pdf"
          className="w-full h-8 ring ring-teal-700 bg-teal-700/80 text-white/80 hover:text-white hover:bg-teal-700 rounded cursor-pointer flex justify-center items-center p-1.5 transition-all delay-50"
        />
      </div>
